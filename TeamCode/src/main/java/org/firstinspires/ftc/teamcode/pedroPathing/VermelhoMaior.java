...
@Autonomous
@Configurable
public class VermelhoMaior extends OpMode {
    ...
    public void init() {
        ...
        follower.setStartingPose(new Pose(112.000,134.5,Math.toRadians(180)));
